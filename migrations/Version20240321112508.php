 ...
 */
final class Version20240321112508 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE meals (id INT AUTO_INCREMENT NOT NULL, meal_plan_id INT DEFAULT NULL, day_of_week VARCHAR(255) NOT NULL, breakfast JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', second_breakfast JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', lunch JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', snack JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', dinner JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', INDEX IDX_E229E6EA912AB082 (meal_plan_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE profile (id INT AUTO_INCREMENT NOT NULL, userid_id INT NOT NULL, weight DOUBLE PRECISION NOT NULL, height DOUBLE PRECISION NOT NULL, age INT NOT NULL, gender VARCHAR(255) NOT NULL, activitylevel VARCHAR(255) NOT NULL, dietpreferences VARCHAR(255) DEFAULT NULL, allergies VARCHAR(255) DEFAULT NULL, calorieresrequirement DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_8157AA0F58E0A285 (userid_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
